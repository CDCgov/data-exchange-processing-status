...
class UploadStatusLoader: CosmosLoader() {
    ...
    fun getUploadStatus(dataStreamId: String,
        ...
        sqlQuery.append("from $reportsContainer t where t.dataStreamId = '$dataStreamId'")
        ...
        submissionDate?.run {
            ...
            sqlQuery.append(" and t._ts = $dateSubmittedEpochSecs")
        }
        ...
        if (totalItems > 0L) {
            ...
            results?.forEach { report ->
                ...
                val reportsSqlQuery = "select * from $reportsContainer t where t.uploadId = '$uploadId'"
