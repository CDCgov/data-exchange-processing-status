...
data class Issue(
    ...
    companion object {
         ...
         */
        fun fromIssueDao(dao: gov.cdc.ocio.types.model.Issue?) = Issue().apply {
            this.level = when (dao?.level) {
                gov.cdc.ocio.types.model.Level.ERROR -> Level.ERROR
                gov.cdc.ocio.types.model.Level.WARNING -> Level.WARNING
                else -> null
            }
