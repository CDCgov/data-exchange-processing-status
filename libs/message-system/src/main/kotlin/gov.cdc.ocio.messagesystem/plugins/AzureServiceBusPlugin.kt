...
fun createAzureServiceBusPlugin(processor: MessageSystemProcessor) = createApplicationPlugin(
...
private fun processMessage(context: ServiceBusReceivedMessageContext, processor: MessageSystemProcessor) {
    val logger = KotlinLogging.logger {}
